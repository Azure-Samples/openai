...
from insights_generator import typing_utils

T = typing.TypeVar('T')
Class = typing.Type[T]


def _deserialize(data: Union[dict, list, str], klass: Union[Class, str]
                 ) -> Union[dict, list, Class, int, float, str, bool, datetime.
...
def _deserialize_primitive(
        data, klass: Class) -> Union[Class, int, float, str, bool]:
