    ...
    def initialize(cls):
        if not cls._initialized:
            ...
            try:
                ...
                cls.AZURE_CONTENT_UNDERSTANDING_ENDPOINT = config_reader.read_config_value(
                    Config.AZURE_CONTENT_UNDERSTANDING_ENDPOINT
                )
                cls.AZURE_CONTENT_UNDERSTANDING_API_KEY = config_reader.read_config_value(
                    Config.AZURE_CONTENT_UNDERSTANDING_API_KEY
                )
