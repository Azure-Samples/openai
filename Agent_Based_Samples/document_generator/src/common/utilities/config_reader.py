...
class Config(Enum):
    ...
    IMAGE_CONTENT_SAFETY_CHECK_ENABLED = "IMAGE-CONTENT-SAFETY-CHECK-ENABLED"
    TEXT_CONTENT_SAFETY_CHECK_ENABLED = "TEXT-CONTENT-SAFETY-CHECK-ENABLED"
    ...
    # Azure AI Foundry Tools Configuration
