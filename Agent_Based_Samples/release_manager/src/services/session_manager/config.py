    ...
    def initialize(cls):
        if not cls._initialized:
            ...
            try:
                ...
                cls.AI_FOUNDRY_PROJECT_CONNECTION_STRING = config_reader.read_config_value(Config.AZURE_AI_AGENT_PROJECT_CONNECTION_STRING)
                ...
                cls.CHAT_MAX_RESPONSE_TIMEOUT_IN_SECONDS = int(config_reader.read_config_value(Config.CHAT_MAX_RESPONSE_TIMEOUT_IN_SECONDS))
