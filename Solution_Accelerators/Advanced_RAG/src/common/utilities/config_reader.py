...
class Config(Enum):
    ...
    # Service URLs
    SEARCH_SKILL_URL = "SEARCH-SKILL-URL"
    IMAGE_DESCRIBER_SKILL_URL = "IMAGE-DESCRIBER-SKILL-URL"
    RECOMMENDER_SKILL_URL = "RECOMMENDER-SKILL-URL"
    CONFIGURATION_SERVICE_URL = "CONFIGURATION-SERVICE-URL"
