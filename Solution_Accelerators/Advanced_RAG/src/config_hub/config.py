...
class DefaultConfig:
    ...
    def initialize(cls):
        if not cls._initialized:
            ...
            logger.set_base_properties({"ApplicationName": "CONFIGURATION-SERVICE"})
            ...
            try:
                ...
                cls.COSMOS_DB_CONFIGURATION_CONTAINER_NAME = config_reader.read_config_value(Config.AZURE_COSMOS_DB_CONFIGURATION_CONTAINER_NAME)

                cls.SERVICE_HOST = os.getenv(Config.SERVICE_HOST.value, "0.0.0.0")
                cls.SERVICE_PORT = os.getenv(Config.SERVICE_PORT.value, "5003")
